...
class FAQuestionController: UITableViewController {

    @IBOutlet var tblFAQQuestion: UITableView!
    var arrayQuestions = [FAQQuestionStruct]()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        tblFAQQuestion.delegate     = self
        tblFAQQuestion.dataSource   = self
//        loadQuestions()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellFAQQuestion", for: indexPath) as! FAQQuestionViewCell
